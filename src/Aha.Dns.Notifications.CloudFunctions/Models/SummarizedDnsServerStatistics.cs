...
namespace Aha.Dns.Notifications.CloudFunctions.Models
{
    public class SummarizedDnsServerStatistics
    {
        /*
         * This is the same model that's in Aha.Dns.Statistics.Common.Models.SummarizedDnsServerStatistics
         * It should really be moved into a public contract but I don't have time to fix that right now.
         * Fix later!
         */
